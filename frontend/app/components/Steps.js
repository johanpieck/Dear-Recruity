...
const Steps = (props) => (
  <div className={styles.container} data-tid="container">
    ...
    <h2>deer recruity</h2>
    <Link className={styles.linkTopHomepage} to="/">Back to frontpage</Link>
    <div className={styles.steps}>
      {props.fields.map((object, i) => <div key={object.fields.question}> {i+1}: {object.fields.question} </div>)}
    </div>
  </div>
);
